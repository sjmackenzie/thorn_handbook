#+TAGS: duffles aresnick lucy
#+FILETAGS: sprout_www

#+STARTUP: hidestars lognoteclock-out

* TODO First iteration
  DEADLINE: <2008-12-25 Thu>
** TODO Make storytelling easy [0/3]				       :duffles:
   DEADLINE: <2009-01-15 Thu>
...
*** TODO Write wrapper around map choice for displaying maps
...
** TODO Working document of sprout handbook [5 hours] 	      :aresnick:duffles:
   DEADLINE: <2009-01-03 Mon>
