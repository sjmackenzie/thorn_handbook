...
# This file is ${filename} of the ${projectName} project.  It is
# maintained by ${username} of ${userURL}.  Any questions or concerns
# about this file should be directed to ${emailAddress}.  Take a look
...
#+AUTHOR: maintained by ${username} of ${userURL} 
#+EMAIL: ${emailAddress}
#+DATE: ${date}
#+LANGUAGE: ${language}
#
...
#+FILETAGS: sprout ${filename} ${projectName}
#
#
# ---
#
...
* TODO Replan/redate thorn handbook				      :aresnick:
  DEADLINE: <2009-03-18 Wed>
